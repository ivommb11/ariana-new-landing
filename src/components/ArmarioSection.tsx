...
const ArmarioSection = () => {
  ...
  // ================================================================
  // === Tus rutas de imágenes (las he mantenido) ===
  // ================================================================
  ...
  return (
    <section id="destaca" className="bg-background">
      <div className="grid grid-cols-1 md:grid-cols-[1.5fr_2fr_1.5fr] gap-8 md:gap-12 lg:gap-16 min-h-screen">

        {/* === Columna izquierda (sin cambios) === */}
        <div className="hidden md:grid w-full grid-cols-2 grid-rows-[2fr_1fr_1fr] gap-4">
        ...
        {/* ============================================== */}
        {/* === INICIO DE CAMBIOS en "Texto central" === */}
        {/* ============================================== */}

        <div className="w-full flex flex-col justify-center py-20 md:py-0 px-6">

          <div className="max-w-lg mx-auto text-left">

            {/* === ESTE ES EL NUEVO DIV QUE AGRUPA LOS TÍTULOS === */}
            <div className="ml-16">

              {/* Bloque 1: "TU ARMARIO" */}
              <div>
                <h2 className="relative text-3xl md:text-4xl lg:text-5xl font-light leading-tight ml-12 font-abril">

                  {/* === CAMBIO AQUÍ: '-left-10' a '-left-12' (o -left-14) === */}
              ...
              <div className="-mt-2 ml-10">
                ...
                <p className="relative text-3xl md:text-4xl lg:text-5xl italic font-light text-primary leading-tight">
                  ...
                  {/* === CAMBIO AQUÍ: 'right1' corregido a '-right-4' === */}
                  {/* Aumenta el '4' (ej. -right-6, -right-8) para moverla MÁS a la derecha */}
                  <span className="absolute text-[#8f8060] not-italic text-6xl md:text-7xl lg:text-8xl right-8 top-0">
                    ❞
                  </span>
                </p>
              </div>
            ...
            {/* === AQUÍ TERMINA EL GRUPO DE TÍTULOS === */}


            {/* Bloque 4: Párrafo (sin cambios) */}
            <div className="mt-8 ml-12">
              <p className="text-sm md:text-base font-light leading-relaxed text-muted-foreground text-center">
                ...
                mentre l’energia pulsava come un fiume in.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* ============================================ */}
        {/* === FIN DE CAMBIOS en "Texto central" === */}
        {/* ============================================ */}


        {/* === Columna derecha (sin cambios) === */}
        <div className="hidden md:grid w-full grid-cols-2 grid-rows-[1fr_1fr_2fr] gap-4">
        ...
        {/* === Cuadrícula para Móvil (sin cambios) === */}
        <div className="grid grid-cols-2 gap-4 md:hidden px-6 pb-20">
